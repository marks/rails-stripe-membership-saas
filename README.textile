This repo (https://github.com/marks/rails-stripe-membership-saas)'s `mongoid` branch is marks/@Skram's experiment to port `rails-stripe-membership-saas` to work with MongoDB complements of the mongoid gem.
